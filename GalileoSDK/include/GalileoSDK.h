...
public:
  ...
  GALILEO_RETURN_CODE
  GetCurrentStatus(galileo_serial_server::GalileoStatus *status);
  ...
  GALILEO_RETURN_CODE SetCurrentStatusCallback(void (*callback)(
      GALILEO_RETURN_CODE, galileo_serial_server::GalileoStatus));
  GALILEO_RETURN_CODE SetGoalReachedCallback(
